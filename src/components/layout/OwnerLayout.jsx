...
const gradientBg = "linear-gradient(135deg, #2193b0 0%, #6dd5ed 100%)";
...
const menuItems = [
  { label: "Home", icon: "mdi:home", path: "/owner/dashboard" },
  { label: "Profile", icon: "pajamas:profile", path: "/owner/profile" },
];
